...
let mySprite = sprites.create(img`
    ...
    . . . . f 8 8 f 8 8 f . . . . . 
    . . . f 8 8 f f f 8 8 f . . . . 
    . . f 8 8 f f f f f 8 8 f . . . 
    . f 8 8 f f f f f f f f f . . . 
    . f 8 8 2 1 f 1 f 1 2 8 f . . . 
    . f 8 2 2 1 1 1 1 1 2 8 f . . . 
    . f 8 2 8 8 1 2 1 8 2 2 f . . . 
    . . f 2 8 f 1 1 1 f 8 f . . . . 
    . . . f f f f 1 f f f . . . . . 
    . . . c f f 1 f 1 f f c . . . . 
    . . c c f f f 1 f f f c c . . . 
    . . . c . f 1 f 1 f . c . . . . 
    . . . . . f f 1 f f . . . . . . 
    . . . . . 1 1 . 1 1 . . . . . . 
    `, SpriteKind.Player)
...
game.onUpdateInterval(1000, function () {
    mySprite2 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        . . . e e e e e e e e . . . . . 
        . . e 4 4 e 4 7 4 e 7 e e . . . 
        . e 4 4 8 2 8 e e 8 2 8 e . . . 
        . e 4 e 2 f 2 e 7 2 f 2 e . . . 
        . e 4 4 8 2 8 e e 8 2 8 7 . . . 
        . . e 4 1 1 7 1 d d d e 7 . . . 
        . . . e 7 e f f f e 7 . . . . . 
        . . . . . 7 1 1 d . . . . . . . 
        . . . . . 7 1 7 d . . . . . . . 
        . . . . d 1 1 d d . . . . . . . 
...
forever(function () {
    music.play(music.stringPlayable("C5 - B B C5 - A C5 ", 136), music.PlaybackMode.UntilDone)
})
